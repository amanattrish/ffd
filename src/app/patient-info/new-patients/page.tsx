        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {newPatients.whatToExpect.items.map((item, index) => {
            ...
            return (
              ...
              >
                <span className="w-16 h-16 rounded-full bg-[var(--color-primary)]/10 flex items-center justify-center mx-auto mb-4">
      ...
      <Section background="gray">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            <span className="w-12 h-12 rounded-full bg-[var(--color-secondary)] flex items-center justify-center">
            ...
            <ul className="space-y-3">
              {newPatients.firstVisit.items.map((item, index) => (
                <li key={index} className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-[var(--color-secondary)] flex items-center justify-center flex-shrink-0 mt-0.5">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {newPatients.paperwork.forms.map((form, index) => (
              ...
              >
                <span className="w-12 h-12 rounded-xl bg-[var(--color-primary)]/10 flex items-center justify-center flex-shrink-0">
                ...
                <Download className="w-5 h-5 text-[var(--color-primary)] flex-shrink-0" />
              </a>
            ))}
          </div>
        </div>
